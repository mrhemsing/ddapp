...
export const fakeRoute: RoutePack = {
  ...
  introAudio: "/audio/elevenlabs-review/intro-route-signal-20260630-imhere.mp3",
...
Here are the rules. Stay in the car unless we tell you it is safe to step out. Keep your doors locked. Keep your voices down, because some of these places answer back. When you arrive and it is safe to stop, tap to begin the file, and the rest of you stop talking.
